...
int16_t FT_DispWidth = 480;
int16_t FT_DispHeight = 272;
int16_t FT_DispHCycle =  548;
int16_t FT_DispHOffset = 43;
int16_t FT_DispHSync0 = 0;
int16_t FT_DispHSync1 = 41;
int16_t FT_DispVCycle = 292;
int16_t FT_DispVOffset = 12;
int16_t FT_DispVSync0 = 0;
int16_t FT_DispVSync1 = 10;
uint8_t FT_DispPCLK = 5;
char FT_DispSwizzle = 0;
char FT_DispPCLKPol = 1;
char FT_DispCSpread = 1;
char FT_DispDither = 1;

/* Global used for buffer optimization */
Ft_Gpu_Hal_Context_t host,*phost;

uint32_t Ft_CmdBuffer_Index;
uint32_t Ft_DlBuffer_Index;
...
void Ft_BootupConfig()
{
	Ft_Gpu_Hal_Powercycle(phost,TRUE);
    ...
    Ft_Gpu_Hal_WrMem(phost, RAM_DL,(uint8_t *)FT_DLCODE_BOOTUP,sizeof(FT_DLCODE_BOOTUP));
...
//  Set the bitmap properties , sketch properties and Tracker for the sliders
  ...
  while(1)
  {
   ...
   // draw the sliders 
    ...
    Ft_App_WrCoCmd_Buffer(phost,VERTEX2F((int16_t)(FT_DispWidth-40)*16,(int16_t)(FT_DispHeight-20)*16));			
